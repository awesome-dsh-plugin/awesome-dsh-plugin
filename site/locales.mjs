...
export default [
  {
    ...
    PRIVACY_DESC: 'What this site collects and what it does not: cookie-less analytics, nothing written to your browser by the site itself, and exactly which ad network runs and what it receives.',
  ...
  },
  {
    ...
    PRIVACY_DESC: '本站收集什么、不收集什么：统计不依赖 cookie，站点自身不写浏览器存储，以及广告到底跑的是哪一家、它会收到什么。',
