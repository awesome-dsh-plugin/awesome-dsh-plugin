...
export default [
  {
    ...
    strings: {
      ...
      CONTRIB_BODY: 'Open a PR against <a href="https://github.com/awesome-dsh-plugin/awesome-dsh-plugin" rel="noopener">awesome-dsh-plugin</a> — add one YAML file under <code translate="no">data/plugins/</code>; the READMEs and site sync automatically after merge. Add the <a href="https://github.com/topics/dsh-plugin" rel="noopener"><code translate="no">dsh-plugin</code></a> topic to your repo too.',
  ...
  },
  {
    ...
    strings: {
      ...
      CONTRIB: '收录你的插件',
      CONTRIB_BODY: '给 <a href="https://github.com/awesome-dsh-plugin/awesome-dsh-plugin" rel="noopener">awesome-dsh-plugin</a> 提一个 PR：在 <code translate="no">data/plugins/</code> 下新增一个 YAML 文件；合并后 README 与网站会自动同步。也请为你的仓库打上 <a href="https://github.com/topics/dsh-plugin" rel="noopener"><code translate="no">dsh-plugin</code></a> topic。',
      MOTTO: '探索未至之境',
