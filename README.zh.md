...
- [easyv-ai/dsh-jumpserver](https://github.com/easyv-ai/dsh-jumpserver) — 通过对话管理 JumpServer 资产与权限，提供 53 个工具，覆盖 10 个领域。
- [easyv-ai/dsh-pve](https://github.com/easyv-ai/dsh-pve) — 通过对话控制 Proxmox VE，提供 232 个工具，覆盖 13 个领域。
