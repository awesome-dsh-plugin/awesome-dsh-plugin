...
- [Qinling-Melon-Farmers/dsh-memoir](https://github.com/Qinling-Melon-Farmers/dsh-memoir) — DeepSeek Harness 本地项目记忆插件，提供有界 Hot Memory 提示词注入、BM25 排序召回、带生命周期的记忆记录、自动归纳提醒与 Web 管理面板。
