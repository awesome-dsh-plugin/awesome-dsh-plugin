...
- [InkshadeWoods/dsh-tool-visual-primitives](https://github.com/InkshadeWoods/dsh-tool-visual-primitives) — 为纯文本模型桥接图像理解：分析对话中的图片，将结构化证据（图像描述、定位框、UI 布局）以文本注入上下文。
