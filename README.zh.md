...
- [PionAI/dsh-web-search-firecrawl](https://github.com/PionAI/dsh-web-search-firecrawl) — 基于 Firecrawl 的网页搜索提供方：让内置 web_search 走 Firecrawl 搜索 API，并提供 API Key、结果数量与「使用 Firecrawl」开关的设置卡片。
