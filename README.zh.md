...
- [ankye/dsh-image-generation](https://github.com/ankye/dsh-image-generation) — DSH 生图插件：generate_image 模型工具，可配置 OpenAI 兼容端点（gpt-image-2）、宽高比/质量/张数与输出目录设置卡片，API Key 经凭据服务按通道存储。
