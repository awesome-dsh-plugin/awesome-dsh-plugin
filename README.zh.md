...
- [hellosky983/dsh-mc-launcher](https://github.com/hellosky983/dsh-mc-launcher) — DeepSeek Harness 的 Minecraft 启动器：下载安装版本、微软正版登录、启动游戏，并驱动一个能自主生存、游戏内聊天、带实时地图的 Mineflayer bot。
