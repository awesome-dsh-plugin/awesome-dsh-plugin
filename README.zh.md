...
- [fatemarcus-hub/dsh-balance](https://github.com/fatemarcus-hub/dsh-balance) — DeepSeek 余额按钮：在 DSH 设置按钮右侧显示 DeepSeek API 账户余额（总额/充值/赠送/状态），点击查看、一键跳转官方充值页，低余额变红提醒。
