...
- [temotee2103/dsh-overdrive#gateway-core](https://github.com/temotee2103/dsh-overdrive/tree/main/packages/gateway-core) — 把 DeepSeek Harness 接入 WhatsApp / Telegram / Discord / Slack / 飞书 / 钉钉 / 企业微信，支持聊天内轨迹回放、子任务、定时任务与一键审批。
