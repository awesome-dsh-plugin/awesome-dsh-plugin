...
- [badai147/dsh-ocgo-usage](https://github.com/badai147/dsh-ocgo-usage) — OpenCode Go 用量小部件：左下角常驻角标显示本月剩余额度，悬停卡片展示滚动/本周/本月用量进度与重置时间，每 60 秒自动刷新；API Key 自动读取 DSH 凭据。
