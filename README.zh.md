...
- [ninipa/oh-my-dsh-slim](https://github.com/ninipa/oh-my-dsh-slim) — 专家子代理委派预设（orchestrator + 5 角色：oracle/designer/fixer/explorer/librarian），安装即自动播种——后台优先派发，JSON 驱动模型/effort/工具权限，调研角色带 MCP。
