...
- [klingai-dev/deepseek-plugin](https://github.com/klingai-dev/deepseek-plugin) — 可灵 AI 官方 DeepSeek Harness 插件。使用自然语言完成文生图、图生图、文生视频、图生视频、参考图创作、任务跟踪、OAuth 账号授权和结果预览。
