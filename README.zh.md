...
- [dsh-pulse/dsh-hermes-bridge](https://github.com/dsh-pulse/dsh-hermes-bridge) — Two-way WeChat bridge for DeepSeek Harness via a Hermes gateway: dispatch tasks from WeChat into DSH agents with persistent per-cwd sessions, and push progress, results and errors back with zero LLM tokens.
