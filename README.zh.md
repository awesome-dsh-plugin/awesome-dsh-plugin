...
- [zhangbo1201/dsh-file-upload](https://github.com/zhangbo1201/dsh-file-upload) — Web 输入框回形针与 Cmd/Ctrl+V 普通文件上传：将文件复制到当前工作区的 .dsh-uploads/ 目录并插入 @路径，同时保留 PNG/JPG/WebP/GIF 原生图片附件流程。
