...
- [FuqiangCraft/dsh-desktop#dsh-desktop-plugin](https://github.com/FuqiangCraft/dsh-desktop/tree/main/packages/dsh-desktop-plugin) — 提供桌面宠物、原生通知、最近会话托盘操作、屏幕截图与多智能体画布。
