...
- [hoyyang/dsh-concise](https://github.com/hoyyang/dsh-concise) — DeepSeek Harness 一键 Concise 输出风格开关：结果先行、少废话，工作深浅不变。每轮回答开头自动附「摘要」精华卡（划选即复制），按会话独立生效，支持 /concise 命令、style.md 自定义风格与本地 API。
