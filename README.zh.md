...
- [kenny2077/dsh-web-search-zai](https://github.com/kenny2077/dsh-web-search-zai) — 基于 ZAI（智谱/GLM）的网页搜索提供方：把内置 web_search 的后端切换为 Z.ai 独立搜索 API，与 GLM 聊天模型共用同一个 ZAI_API_KEY。
