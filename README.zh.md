...
- [rainow/dsh-simple-wiki-memory](https://github.com/rainow/dsh-simple-wiki-memory) — 超级简化版 llm-wiki 记忆：一个自动注入的索引文档 + 每个主题一个按需读取的 md 文件；pending 准入→晋升→归档 + 追加式日志与 git 自动备份，纯 Markdown 跨 harness 共享。
