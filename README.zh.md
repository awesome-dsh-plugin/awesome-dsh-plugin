...
- [fan56/dsh-llm-net-retry](https://github.com/fan56/dsh-llm-net-retry) — 网关 finish_reason: network_error 兜底重试插件：dsh 原生重试策略将此类失败归为不可重试，本插件在 agent/request-error waterfall 末端兜底，避免整轮硬失败。
