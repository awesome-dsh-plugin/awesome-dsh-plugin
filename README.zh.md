...
- [liang-today/dsh-liangxiang](https://github.com/liang-today/dsh-liangxiang) — DeepSeek Harness WebUI 插件：把输入与输出 Token 折算成香火，花一炷对当日社区梁案投夯或拉，按社区夯率显示今日梁子，日终将结果收入梁祠。
