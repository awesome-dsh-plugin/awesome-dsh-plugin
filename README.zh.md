...
### 🧩 技能包
- [caoqinnan-web/dsh-project-organizer](https://github.com/caoqinnan-web/dsh-project-organizer) — 根据完整对话内容，把模糊的 AI 自动标题整理为清晰的 `类别｜主题` 名称；ChatGPT 已验证，DSH 支持仍处于实验阶段。
