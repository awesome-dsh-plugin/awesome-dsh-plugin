...
- [tenglongbohai/dsh-paddle-ocr](https://github.com/tenglongbohai/dsh-paddle-ocr) — Add PaddleOCR vision to text-only LLMs like Agnes, DeepSeek, MiniMax, GLM, and Mimo. Supports local files and URLs. Free.
