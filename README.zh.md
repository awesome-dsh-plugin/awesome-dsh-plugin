...
- [hughyang204/dsh-annotate](https://github.com/hughyang204/dsh-annotate) — DSH Web 内置图片标注画板：右侧侧边栏画箭头/文字/矩形等标注，自动载入最近图片，一键把标注图+整体修改说明发回对话，供 AI 精准局部改图/风格迁移/参考图生成。
