...
- [dataelement/dsh-plugin-coaligne](https://github.com/dataelement/dsh-plugin-coaligne) — 为 DSH 提供 CoAligne 团队共享项目上下文——内置 workflow skill，配合 CoAligne Desktop 自动接入 MCP，访问同步文件、Agent 会话、评论与队友动态。
