...
- [TussalZeus18028/dsh-conflict-checker](https://github.com/TussalZeus18028/dsh-conflict-checker) — 扫描 DSH 加载器中的插件冲突与运行问题(重复挂载、启动失败或依赖等待、设置命名空间与工具名重复、前端加载图问题、反射包重复),并在设置页提供插件管理(启用、禁用、卸载)。
