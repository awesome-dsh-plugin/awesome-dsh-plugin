...
> 🛒 **新 — [dsh-market](https://github.com/dsh-market/dsh-market)：可视化插件市场。**本列表的全部插件,直接在 DeepSeek Harness 里逛:搜索、star 数、一键安装/更新/卸载,多数插件免重启即刻生效。`dsh plugin --profile web add dsh-market`
