...
- [rebron1900/dsh-mnemosyne](https://github.com/rebron1900/dsh-mnemosyne) — Mnemosyne 记忆插件 for DeepSeek Harness：remember / recall / forget / stats / sleep 五个工具 + 内嵌技能 + Settings 面板（CLI 状态/统计/一键安装/配置），数据落 ~/.dsh/mnemosyne，可选自动记忆增强（默认全关）。移植自 mnemosyne-oss/pi-mnemosyne。
