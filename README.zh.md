...
- [heiweilu/dsh-quota-capsule](https://github.com/heiweilu/dsh-quota-capsule) — 跟随会话当前模型供应商的配额胶囊：GLM Coding / Kimi Coding / MiniMax 的 5 小时与每周窗口用量（带重置倒计时）及 DeepSeek 余额，右下角悬浮显示。
