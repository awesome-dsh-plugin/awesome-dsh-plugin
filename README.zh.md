...
- [pgmi-builds/better-dsh#dashr](https://github.com/pgmi-builds/better-dsh/tree/main/dashr) — Dashr（"Better Dsh"）：dsh 的常驻 Python 内核 REPL——eval 单元、tools.* 绑定、scheme:// 资源寻址，以及内置 IDE（LSP、AST、hashline 编辑）。
