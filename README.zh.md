...
- [FAVKTOXIC/dsh-theme-liquid-glass](https://github.com/FAVKTOXIC/dsh-theme-liquid-glass) — 苹果液态玻璃主题：半透明磨砂 UI 层、动态壁纸（网页/HTML/图片/视频）、可调磨砂/折射/颜色/亮度，输入框、发送按钮、消息气泡、视图标签、队列坞和侧边栏按钮的边缘折射效果。
