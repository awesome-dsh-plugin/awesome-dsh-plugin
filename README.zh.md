...
- [Sharl210/dsh-strip-sandbox-permissions](https://github.com/Sharl210/dsh-strip-sandbox-permissions) — 从模型工具调用参数中移除 sandbox_permissions 与 justification，避免会话已有足够权限时触发沙箱升级误拒绝。
