...
- [yehuioc/dsh-memory-pack](https://github.com/yehuioc/dsh-memory-pack) — 文件式分层记忆 skill pack：11 层目录模型、Maps-first 导航、producer/review 元数据契约、污染防护，附零依赖 scaffold/audit 脚本。
