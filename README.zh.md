...
- [YUEEEEY/dsh-desktop-tools](https://github.com/YUEEEEY/dsh-desktop-tools) — dsh 桌面端与环境管理插件：自动打开桌面窗口（内嵌 Rust/Tauri 宿主，支持 Windows/macOS/Linux）、运行时更新管理、Windows 补丁、环境面板与计费页。
