...
- [seriousz158/dsh-codex-use#dsh-codex-appserver](https://github.com/seriousz158/dsh-codex-use/tree/main/packages/dsh-codex-appserver) — 通过 stdio 将 DeepSeek Harness 接入本地 OpenAI Codex App Server：提供只读诊断、ChatGPT 账户与额度元数据、带 revision 防护的设置、按模型能力启用的 Fast Mode，以及 DSH 本地图片附件。
