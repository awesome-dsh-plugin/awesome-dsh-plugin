...
- [platonai/dsh-browser4](https://github.com/platonai/dsh-browser4) — 将 Browser4 技能集（browser4-cli、browser4-experience、browser4-plugin、scent-miner）注册到 DSH 技能库，并安装 browser4-cli 运行时，用于 AI 原生的浏览器自动化。
