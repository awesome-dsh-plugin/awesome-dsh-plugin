...
- [Henta111/dsh-more-models-thinking-level](https://github.com/Henta111/dsh-more-models-thinking-level) — 为 DeepSeek Harness 中的 GPT、Codex、Gemini 及 OpenAI-compatible 模型按模型提供推理等级（off/minimal/low/medium/high/xhigh）。
