...
- [randomix777/dsh-plugin-subscriptions](https://github.com/randomix777/dsh-plugin-subscriptions) — 通过 OAuth 登录订阅制 LLM 提供商（Claude、Codex、Grok、Antigravity、OpenRouter、Agnes AI），在 DSH 中以流式对话和工具调用方式暴露。
