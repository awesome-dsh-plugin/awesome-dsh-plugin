...
- [zeng6125-rgb/dsh-llm-retry-settings](https://github.com/zeng6125-rgb/dsh-llm-retry-settings) — LLM 自动重试设置卡片：实时调整重试次数与退避，并可勾选额外可重试错误码（默认补入 INVALID_REQUEST，OpenAI thinking 模式 HTTP 400 报错开箱即自动重试）。
