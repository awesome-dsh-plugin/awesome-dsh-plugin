...
- [FeilongRong/dsh-balance-widget](https://github.com/FeilongRong/dsh-balance-widget) — 侧边栏「余额」按钮：实时查询 DeepSeek 账户余额，并提供 MiniMax / 百炼 / SCNet 控制台链接；API Key 仅保存在浏览器本地。
