...
- [a1113622001/dsh-session-stats-panel](https://github.com/a1113622001/dsh-session-stats-panel) — DSH Web 界面右侧的会话统计面板，显示平均缓存命中率、会话费用（按 DeepSeek 定价）、账户余额、运行时长、请求数与累计 tokens。
...
- [a1113622001/dsh-auto-update](https://github.com/a1113622001/dsh-auto-update) — 让 DeepSeek Harness 启动器自我更新——检查 npm 上更新的 @deepseek-ai/dsh，暂存 tarball，并在退出时或从 Web 面板应用更新。
