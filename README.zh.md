...
- [Ruiming-cn/dsh-ask-in-sidebar](https://github.com/Ruiming-cn/dsh-ask-in-sidebar) — 在临时 DSH Web 侧边栏中基于主对话快照询问选中的助手文本。
- [Ruiming-cn/dsh-better-at](https://github.com/Ruiming-cn/dsh-better-at) — 缓存 DSH Web 文件与会话引用索引，支持本地 @ 过滤并保留原生 mention 插入。
