...
- [webkubor/dsh-bloom-theme](https://github.com/webkubor/dsh-bloom-theme) — Bloom 莫兰迪主题：八套 OKLCH 配色（雾蓝、朱砂、花瓣、涟漪、鼠尾草、暖石、青金、琥珀），磨砂玻璃面板 + 克制的微动效，顶栏一键切换。16 组「配色 × 明暗」下的文字色全部实测达到 WCAG AA。
