...
- [tttnny/my-dsh#dsh-client-ui-deepseek-bg](https://github.com/tttnny/my-dsh/tree/main/dsh-client-ui-deepseek-bg) — 仿 DeepSeek Harness 官网的 DSH Web 深色皮肤：极光与粒子鲸鱼背景、星座网格、玻璃拟态、Border Beam 状态机、Thinking Orbs 与 Pulse 任务框，设置页内置背景特效 GPU 调优面板。
