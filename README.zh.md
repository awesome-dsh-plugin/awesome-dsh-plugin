...
- [dataelement/dsh-plugin-coaligne](https://github.com/dataelement/dsh-plugin-coaligne) — 将 DSH 接入 CoAligne 团队共享项目上下文，通过 MCP 访问同步文件、Agent 会话、评论与队友动态，并内置 workflow skill。
