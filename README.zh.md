...
- [uckkk/dsh-paint-calc](https://github.com/uckkk/dsh-paint-calc) — 乳胶漆用量计算
- [uckkk/dsh-tile-calc](https://github.com/uckkk/dsh-tile-calc) — 瓷砖用量计算
- [uckkk/dsh-wire-calc](https://github.com/uckkk/dsh-wire-calc) — 电线用量估算
