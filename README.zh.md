...
- [Ultronen/dsh-archived-chats](https://github.com/Ultronen/dsh-archived-chats) — 管理 DeepSeek Harness 已归档聊天：按工作区分组、搜索筛选、标签备注与容量统计，支持按需批量操作、取消归档、永久删除，以及 ZIP 备份导出与恢复。
