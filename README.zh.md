...
- [chengganping-ship-it/dsh-tool-codereview](https://github.com/chengganping-ship-it/dsh-tool-codereview) — 专业代码审查与安全扫描插件，支持 SARIF 输出、OWASP Top 10、AI 增强分析、自动修复和多语言。
