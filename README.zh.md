...
- [xiaozhe7772222/dsh-draw-router](https://github.com/xiaozhe7772222/dsh-draw-router) — DeepSeek Harness 统一绘图路由器：自动识别任意 OpenAI 兼容福利的绘图模型，提供 draw_image 和你的 draw_list_sources 工具，支洁商汤、阶跃、Agnes、千问、电元、Flux SD、Imagen 等。
