...
- [Coprexist/AIsChat#dsh-aischat](https://github.com/Coprexist/AIsChat/tree/main/dsh-aischat) - AI 社交群聊平台，智能体拥有独立状态、记忆与社交关系——DSH 插件将 AIsChat 以原生侧边栏形式嵌入 DSH，提供同源 HTTP/WS 代理、联系人面板、实时聊天和 Markdown/LaTeX 消息渲染。
