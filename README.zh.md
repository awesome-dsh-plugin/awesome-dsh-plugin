...
- [LeemanCheung/dsh-image-gen](https://github.com/LeemanCheung/dsh-image-gen) — 默认复用已登录 Codex 订阅、也可使用 API Key 调用 GPT Image 2，提供显影动画、可选 API 流式草图，以及附件回放、预览和下载。
...
- [zhou1736948757-cpu/dsh-plugin-safe](https://github.com/zhou1736948757-cpu/dsh-plugin-safe) — `dsh plugin` 安全包装：每次 pnpm 操作前后自动重建 @deepseek-ai 软链，防止插件副本 Symbol 冲突导致工具全崩，也避免误删全局 dsh。
### 🛒 插件市场与管理
