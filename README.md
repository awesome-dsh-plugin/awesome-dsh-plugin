...
### Tools & Capabilities
- [godchen520/dsh-web-search-bing](https://github.com/godchen520/dsh-web-search-bing) - Free Bing-backed web search provider for DSH. No API key needed, uses cn.bing.com for mainland China accessibility. Replaces the default DeepSeek search to avoid consuming search quota.
