...
- [february2015/dsh-taskswarm](https://github.com/february2015/dsh-taskswarm) - Multi-agent task orchestration: dependency-ordered waves run in parallel git-worktree lanes, with task packets, cross-model review, and crash recovery.
