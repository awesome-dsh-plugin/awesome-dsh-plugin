...
### Tools & Capabilities
- [godchen520/dsh-web-search-duckduckgo](https://github.com/godchen520/dsh-web-search-duckduckgo) - Free Bing-backed web search provider for DSH. No API key needed, uses cn.bing.com for mainland China accessibility. Replaces the default DeepSeek search to avoid consuming search quota.
- [godchen520/dsh-web-remote](https://github.com/godchen520/dsh-web-remote) - DSH remote access plugin: Cloudflare Quick Tunnel for public access, LAN HTTP/HTTPS direct connection, token authentication, gzip compression, sidebar phone icon, and WeChat bot integration with session control and model switching.
