...
### Tools & Capabilities
- [gloryxpnv/dsh-tool-vision](https://github.com/gloryxpnv/dsh-tool-vision) - Local-first vision for DeepSeek Harness: text-only models get structured JSON evidence (OCR / layout / semantics) from local VLMs (LM Studio, Ollama, vLLM), zero API cost, images never leave your machine.
