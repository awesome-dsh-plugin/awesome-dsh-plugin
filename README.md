...
**129** plugins · [PRs welcome](#contributing)
...
- [dsh-cc-tui](https://github.com/ccch1mneyyy/dsh-cc-tui) - Claude Code-style full-screen terminal UI: pixel-whale header, live status line, and streaming thought expansion.
