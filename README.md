...
- [Sim-xia/dsh-vscode-theme](https://github.com/Sim-xia/dsh-vscode-theme) - allow deepseek harness to import and use .vsix theme file designed for visual studio code long-lasting.
