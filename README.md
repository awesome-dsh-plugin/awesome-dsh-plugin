...
- [zl99103/dsh-answer-sound](https://github.com/zl99103/dsh-answer-sound) - Agent answer sound effects for the Web UI: start/done/error tones following the answering lifecycle, per-kind volume, custom audio files, and a master switch in settings.
