...
=======
**217** plugins · [PRs welcome](#contributing)
...
- [Nanki-nn/dsh-answer-pet](https://github.com/Nanki-nn/dsh-answer-pet) - Animated blue-whale desktop pet with per-session response phases, progress, token counts, output speed, elapsed time, and collapsible multi-session status cards.
