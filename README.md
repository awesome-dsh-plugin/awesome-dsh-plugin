...
- [flymysql/dsh-remote](https://github.com/flymysql/dsh-remote) - Remote workspace: connect a host over SSH (password or key), pick a remote workspace directory served through remote_list_dir / remote_read_file / remote_exec tools.
